...
<html class="h-100" lang="en">
  ...
  <title>Verdict Supply - Mission</title>
...
<li class="nav-item">
  ...
  <div class="row d-flex justify-content-center py-vh-5 pb-0">
    <div class="col-12 col-lg-10 col-xl-8">
      <div class="row">
        <div class="col-12">
           <h1 class="display-1 fw-bold" style="padding-top: 150px;">Our Mission</h1>
          <p class="lead border-top pt-5 mt-5" data-aos="fade-up">There are too many things wrong with the world right now. We're trying to make a small
          difference, one step at a time. By purchasing our clothing, you are helping children in need of clean food and water all around the world get
          the help they deserve. You are helping doctors research cures for cancer, and funding meaningful research to help bring outreach to those who
          need it most. Unfortunately, some people, even in first world countries, don't have access to clean water and safe, healthy food. Not to mention 
          what is happening to the ocean, weather, rainforests, endangered species, and the planet as a whole. Verdict's mission is to create a better tomorrow 
          for future generations by donating 10% of the proceeds earned to meaningful charities around the world! Please help us make a difference by making a 
          purchase or subscribing to our monthly gift box. We donate 10% of the gift box revenue as well, just like our other products.
          </p>
