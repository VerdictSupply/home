...
<html class="h-100" lang="en">
  ...
  <img src="img/verdict_logo_b.png" width="200" height="75" style="padding-right:50px;">
</a>
...
<form class="row">
  ...
  <div class="mb-3">
    ...
    <input type="name" class="form-control form-control-lg bg-gray-800 border-dark" id="exampleInputPassword1">
  </div>
  <div class="mb-3 form-check py-3">
    <input type="checkbox" class="form-check-input" id="exampleCheck1">
    <label class="form-check-label" for="exampleCheck1">I wish to be contacted about designing products for Verdict Supply Co.</label>
  </div>
