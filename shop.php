...
<html class="h-100" lang="en">
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="images/verdict-fav-red.png">
  <link rel="icon" type="image/png" sizes="16x16" href="images/verdict-fav-red.png">
  <link rel="icon" type="image/png" sizes="96x96" href="images/verdict-fav-red.png">
  <meta name="author" content="Holger Koenemann">
  <meta name="generator" content="Eleventy v2.0.0">
  <meta name="HandheldFriendly" content="true">
  <title>Verdict Supply - Shop</title>
...
<li class="nav-item">
  <a class="nav-link fs-5" href="mission.php" aria-label="A system message page">
    ...
    <main>
    <div id="myShop" class="shop_embed">
    <a href="https://verdictsupply.myspreadshop.com"></a>
	</div>

<script>
    var spread_shop_config = {
        shopName: 'verdictsupply',
        locale: 'us_US',
        prefix: 'https://verdictsupply.myspreadshop.com',
        baseId: 'myShop'
    };
</script>

<script type="text/javascript"
        src="https://verdictsupply.myspreadshop.com/shopfiles/shopclient/shopclient.nocache.js">
</script>
    </main>
