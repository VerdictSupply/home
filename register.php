...
<html class="h-100" lang="en">
  ...
  <img src="img/verdict_logo_b.png">
</a>
            </header>
            <main class="mb-auto col-12">
              <h1>Register</h1>
              
<form action="registerHash.php" class="row">
  <div class="col-12">
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="passwordConfirmation" class="form-control form-control-lg bg-gray-800 border-dark" id="passwordConfirmation">
  </div>
