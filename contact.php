...
<html class="h-100" lang="en">
  ...
  <title>Verdict Supply - Contact</title>
...
<li class="nav-item">
  <a class="nav-link fs-5" href="mission.php" aria-label="Our Mission">
    Our Mission
  </a>
</li>
  ...
  <div class="row d-flex justify-content-center py-vh-5 pb-0">
    <div class="col-12 col-lg-10 col-xl-8">
      <div class="row">
        <div class="col-12">
           <h1 class="display-1 fw-bold" style="padding-top: 150px;">Contact Info</h1>
           <br>
			<p>Supplier Phone Number
			<br> <a href="tel:800-381-0815">+1 800-381-0815</a></p>
			<p>Supplier Email
			<br> <a href="mailto:service@spreadshirt.com">service@spreadshirt.com</a></p>
			<p>Verdict Supply Email
			<br> <a href="mailto:verdictsupply@gmail.com">verdictsupply@gmail.com</a></p>
			<p>Verdict Supply Phone Number
			<br> <a href="tel:310-924-4749">+1 310-924-4749</a></p>
