...
<html class="h-100" lang="en">
  ...
  <title>Verdict Supply - TOS</title>
...
<li class="nav-item">
  ...
  <div class="row d-flex justify-content-center py-vh-5 pb-0">
    <div class="col-12 col-lg-10 col-xl-8">
      <div class="row">
        <div class="col-12">
           <h1 class="display-1 fw-bold" style="padding-top: 120px;">Terms of Service</h1>
          <p class="lead border-top pt-5 mt-5" data-aos="fade-up">By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Verdict's website if you do not accept all of the terms and conditions stated on this page.
